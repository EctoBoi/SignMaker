...
export const signConfigs: { [key: string]: SignConfig } = {
    ...
    "3x5 Sign Insert": {
        ...
        allowMirror: true,
        mirrorDirection: "vertical",
        title1: { fontSize: "8mm", x: "0", y: "12mm", centered: true },
        title2: { fontSize: "8mm", x: "0", y: "19.5mm", centered: true },
        extras: { fontSize: "4.5mm", x: "0", y: "54mm", centered: true },
        price: {
            fontSize: "34mm",
            fontSizeWithExtras: "32mm",
            x: "0",
            dollarsY: "51mm",
            dollarsYWithExtras: "49mm",
            centsY: "40mm",
            centered: true,
            margin: "10mm",
        },
